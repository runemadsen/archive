...
const EXT_CATEGORY = {
  image:
    "png jpg jpeg gif webp tif tiff heic avif bmp svg arw sr2 srf cr2 cr3 nef nrw raf orf rw2 dng pef srw 3fr iiq rwl mrw dcr kdc mos",
...
const EXT_TO_CATEGORY = new Map(
  Object.entries(EXT_CATEGORY).flatMap(([cat, exts]) =>
    exts.split(" ").map((e) => [e, cat]),
  ),
);
